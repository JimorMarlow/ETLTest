...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body.large-font .network-name { font-size: 18px; }
        body.large-font .network-signal { font-size: 15px; }
        ...
        body.large-font .network-lock, body.large-font .network-checkmark { font-size: 16px; }
        ...
        .inline-disconnect-btn { width: 100%; height: 40px; border: 1px solid #FF3B30; border-radius: 8px; background: #FFFFFF; color: #FF3B30; font-size: 15px; font-weight: 600; cursor: pointer; transition: all 0.2s; }
        .inline-disconnect-btn:hover { background: #FF3B30; color: #FFFFFF; }
        ...
        body.large-font .input-field { height: 52px; font-size: 18px; }
        ...
        body.large-font .show-password-btn { font-size: 15px; }
        ...
        body.large-font .btn { height: 52px; font-size: 18px; }
    ...
    <script>
        ...
        async function connectToNetwork(index) {
            ...
            try {
                ...
                const response = await fetch('/api/connect', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ ssid: network.ssid, password }), signal: controller.signal });
