...
- ✅ В настройки ui_config_t добавлен флаг dark_theme. Добавлена настройка в контейнер "Interface setup", сохранение и считывание во флеш память
- Нужно реализовать переключение темы в html веб сервера
